...
class SimulationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data["types"] = Simulation::select("home_type")->distinct()->get();
        return view("manage.simulations",$data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $home->save();
        return redirect("/simulations")->with("note","تمت الإضافة");
    }
    ...
    {
        $home = Simulation::find($request->home_id);
        $home->home_ar = $request->home_ar;
        $home->home_en = $request->home_en;
        ...
        return redirect("/simulations")->with("note","تم التعديل");
    }
    ...
    {
        $home = Simulation::find($simulation);
        File::delete(public_path("sliders/$home->home_image"));
        $home->delete();

        return redirect("/simulations")->with("note","تم الحذف");
    }
}
