    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer justify-content-between" align="center" dir="rtl">
          ...
          <a href="{{ url('/Simulations') }}" class="btn btn-primary">إلغاء البحث</a>
        </div>
...
<div class="modal fade" id="add">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="/newSimulation"  enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="basic-form">
                        ...
                        <div class="form-group">
                            ...
                            <select name="home_type" class="form-control">
                                @foreach ($types as $type)
                                @if($type->home_type == "Goals" ||$type->home_type == "Values")
                                    <option value="{{ $type->home_type }}">{{ $type->home_type }}</option>
                                @endif
                                @endforeach
                            </select><br><br>
...
<div class="modal fade" id="edit">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="/updateSimulation" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-title">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style1 mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">الحوسبة والمحاكاة</a></li>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if($j->home_type == "Goals" ||$j->home_type == "Values")
                                            <a onclick="destroy('destroySimulation',{{ $j->id }})" href="javascript:void(0);" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
                                        @endif
                                    </td>
                                </tr>
                                @php $i++; @endphp
