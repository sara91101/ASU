    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body font-weight-bold" dir="rtl">
          <form method="post" action="/coalitions">
            @csrf
        ...
        <div class="modal-footer justify-content-between" align="center" dir="rtl">
          ...
          <a href="{{ url('/coalitions') }}" class="btn btn-primary">إلغاء البحث</a>
        </div>
...
<div class="modal fade" id="add">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="/newCoalition"  enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="edit">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="/updateCoalition" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-title">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-style1 mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">إئتلاف المكتبات </a></li>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{--  @if($j->home_type != "Vision" ||$j->home_type != "Mission")
                                            <a onclick="destroy('destroyCoalition',{{ $j->id }})" href="javascript:void(0);" class="btn btn-sm btn-danger"><i class="la la-trash-o"></i></a>
                                        @endif  --}}
                                    </td>
                                </tr>
                                @php $i++; @endphp
