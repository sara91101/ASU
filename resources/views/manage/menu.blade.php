                    ...
                    <div class="header-element">
                        <div class="horizontal-logo">
                            <a href="/home" class="header-logo">
                                <img src="/images/logo-1.png" alt="logo" class="desktop-logo">
                                <img src="/images/logo-1.png" alt="logo" class="toggle-logo">
                                <img src="/images/logo-1.png" alt="logo" class="desktop-dark">
                                <img src="/images/logo-1.png" alt="logo" class="toggle-dark">
                                <img src="/images/logo-1.png" alt="logo" class="desktop-white">
                                <img src="/images/logo-1.png" alt="logo" class="toggle-white">
                            </a>
                        </div>
                    </div>
                    <!-- End::header-element -->
                    ...
                    <ul class="main-menu">
                        ...
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">
                                ...
                                <span class="side-menu__label">
                                    الإعدادات
                                    <span class="badge bg-warning-transparent ms-2">8</span>
                                </span>
                                <i class="fe fe-chevron-right side-menu__angle"></i>
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide">
                                    <a href="/website" class="side-menu__item"> بيانات الموقع</a>
                                </li>
                                <li class="slide">
                                    <a href="/team" class="side-menu__item"> فريق العمل</a>
                                </li>
                                <li class="slide">
                                    <a href="/advertisements" class="side-menu__item">الإعلانات </a>
                                </li>
                                <li class="slide">
                                    <a href="/faqs" class="side-menu__item"> الأسئلة الشائعة</a>
                                </li>
                                <li class="slide">
                                    <a href="/contacts" class="side-menu__item">   إستفسارات الزوار</a>
                                </li>
                                <li class="slide">
                        ...
                        {{--  <li class="slide">
                            <a href="/website" class="side-menu__item">
                        ...
                        <li class="slide has-sub">
                            ...
                            <ul class="slide-menu child1">
                                <li class="slide">
                                    <a href="/universities" class="side-menu__item"> قائمة الأعضاء</a>
                                </li>
                                <li class="slide">
                                    <a href="/services_requests" class="side-menu__item"> طلبات الخدمات</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <!-- Start::slide -->
                        <li class="slide">
                            <a href="/units" class="side-menu__item">
                        ...
                        <!-- Start::slide -->
                        <li class="slide">
                            <a href="/committees" class="side-menu__item">
                      ...
                      <li class="slide">
                            <a href="/dspaceLinks" class="side-menu__item">
                        ...
                        <!-- Start::slide -->
                        <li class="slide">
                            <a href="/simulations" class="side-menu__item">
                                <i class="las la-robot side-menu__icon"></i>
                                <span class="side-menu__label">
                                    الحوسبة والمحاكاة
                                </span>
                            </a>
                        ...
                        <!-- Start::slide -->
                        <li class="slide">
                            <a href="/coalitions" class="side-menu__item">
                                <i class="bx bx-link-alt side-menu__icon"></i>
                                <span class="side-menu__label">
                                    إئتلاف المكتبات
                                </span>
                            </a>
                        ...
                        <li class="slide has-sub">
                            <a href="javascript:void(0);" class="side-menu__item">
                                ...
                                <span class="side-menu__label">
                                     التقارير
                                    <span class="badge bg-warning-transparent ms-2">3</span>
                                </span>
                                <i class="fe fe-chevron-right side-menu__angle"></i>
                            </a>
                            <ul class="slide-menu child1">
                                <li class="slide">
                                    <a href="/universitiesByService" class="side-menu__item">تقرير الطلبات بالخدمة</a>
                                </li>
                                <li class="slide">
                                    <a href="/universitiesByTypes" class="side-menu__item">تقرير الطلبات بالأعضاء</a>
                                </li>
                                {{--  <li class="slide">
                                    <a href="/contactsByCategory" class="side-menu__item">تقرير الإستفسارات بالتصنيف</a>
                                </li>  --}}
                            </ul>
                        </li>
                        <!-- End::slide -->
        ...
        <footer class="footer mt-auto py-3 bg-white text-center">
            <div class="container justify-content-between">
                <span class="text-muted"> Copyright © <span id="year"></span> <a
                        href="javascript:void(0);" class="text-dark fw-semibold"> إتحاد الجامعات السودانية</a>.
                    Designed with <span class="bi bi-heart-fill text-danger"></span> by <a href="/">
                        <span class="fw-semibold text-primary text-decoration-underline">ASU</span>
                    </a> All
                    rights
                    reserved
                </span>
