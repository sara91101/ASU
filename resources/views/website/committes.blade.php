...
@section("content")
    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s">{{ trans('app.committe') }}</h4>
        </div>
    </div>
    <!-- Header end -->
                    ...
                    @foreach ($committes as $committe)
                        <div class="col-md-12 col-lg-12 col-xl-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="feature-item p-4 pt-0" align="center">
                                ...
                                <h4 class="mb-4">{{ $committe[trans('app.member_val')] }}</h4>
                                <a class="btn btn-primary rounded-pill py-2 px-4" href="/committee/{{ $committe->id }}">{{ trans('app.more') }}</a>
                            </div>
                        </div>
                    @endforeach
