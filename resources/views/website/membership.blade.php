            ...
            <div class="row d-flex justify-content-center">
                <div class="col-12">
                    <div class="wizard">
                        ...
                        <form role="form" action="/subscribe" class="login-box"  method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="tab-content" id="main_form">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label><i class="text-danger">*</i> {{ trans("app.arabic_name") }}</label>
                                                <input type="name" name="ar_name" id="name" class="form-control" required><br>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label><i class="text-danger">*</i> {{ trans("app.english_name") }}</label>
                                                <input type="name" name="en_name" id="en_name" class="form-control" required><br>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                            ...
                                            <input type="file" name="logo" id="logo" class="form-control" accept="image/png, image/jpg, image/jpeg" required><br>
                                        </div>
                                        ...
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <textarea name="others" class="form-control"></textarea><br>
                                        </div>
                                    </div>
                                ...
                                <div class="tab-pane" role="tabpanel" id="step2">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                            <input type="name" name="manager_name" placeholder="{{ trans('app.name') }}" class="form-control" ><br>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                            <input type="text" name="manager_address" placeholder="{{ trans('app.address') }}" class="form-control" ><br>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                            <input type="phone" name="manager_phone" placeholder="{{ trans('app.phone') }}" class="form-control" ><br>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                            <input type="email" name="manager_email" placeholder='{{ trans("app.our_email") }}' class="form-control" ><br>
                                        </div>
                                        ...
                                        <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                            <input type="name" name="sub_manager_name" placeholder="{{ trans('app.name') }}" class="form-control" ><br>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                            <input type="text" name="sub_manager_address" placeholder="{{ trans('app.address') }}" class="form-control" ><br>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                            <input type="phone" name="sub_manager_phone" placeholder="{{ trans('app.phone') }}" class="form-control" ><br>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                            <input type="email" name="sub_manager_email" placeholder='{{ trans("app.our_email") }}' class="form-control" ><br>
                                        </div>
                                        ...
                                        <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                            <input type="name" name="execution_manager_name" placeholder="{{ trans('app.name') }}" class="form-control" ><br>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                            <input type="text" name="execution_manager_address" placeholder="{{ trans('app.address') }}" class="form-control" ><br>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                            <input type="phone" name="execution_manager_phone" placeholder="{{ trans('app.phone') }}" class="form-control" ><br>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-12 col-sm-12">
                                            <input type="email" name="execution_manager_email" placeholder='{{ trans("app.our_email") }}' class="form-control" ><br>
                                        </div>
                                        <div class="form-group col-lg-12 col-md-12 col-sm-12">
